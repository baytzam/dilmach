            ...
            <div class="row">
                <div class="col-lg-8 col-md-12">
                    <div class="purchase-guide-content">
                        ...
                        <p><i>This Purchase Guide was last updated on January 1, 2021.</i></p>
                        <h3>1. Our website</h3>
                        <p>Our website address is: http://vdemy.com</p>
                        ...
                        <blockquote class="blockquote">
                            <p>We collect certain data from you directly, like information you enter yourself, data about your participation in courses, and data from third-party platforms you connect with Vdemy. We also collect some data automatically, like information about your device and what parts of our Services you interact with or spend time using.</p>
                        </blockquote>
